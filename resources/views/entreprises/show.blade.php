...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div class="bg-white shadow-md rounded-xl p-4">
            <h3 class="text-lg font-semibold mb-3">Ventes par période (mois/année)</h3>
        ...
        <div class="bg-white shadow-md rounded-xl p-4">
            <h3 class="text-lg font-semibold mb-3">Ventes par catégorie</h3>
    ...
    <div class="bg-white shadow-md rounded-xl p-4 mt-6">
        <h3 class="text-lg font-semibold mb-3">Top 5 des produits les plus vendus</h3>
                ...
                <table class="min-w-full text-sm text-left">
                    <thead>
                        <tr class="border-b bg-gray-100">
                            ...
                            <th class="py-2 px-4 font-semibold">Quantité totale</th>
                        </tr>
                    </thead>
                    <tbody>
                        @foreach($stats['produitsPlusVendus'] as $produit)
                            <tr class="border-b hover:bg-gray-50">
                                <td class="py-2 px-4">{{ $produit->produit }}</td>
                                <td class="py-2 px-4">{{ $produit->quantite_totale }}</td>
                            </tr>
                        @endforeach
                    </tbody>
                </table>
